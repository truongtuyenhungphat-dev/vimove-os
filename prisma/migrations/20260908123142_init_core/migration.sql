...
-- CreateEnum
CREATE TYPE "RoleKey" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'DIRECTOR', 'MANAGER', 'MARKETING_MANAGER', 'MARKETING_STAFF', 'SALES_MANAGER', 'SALES', 'CONTENT', 'ANALYST', 'STAFF', 'VIEWER');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('SYSTEM', 'TASK', 'APPROVAL', 'MENTION', 'ALERT');
